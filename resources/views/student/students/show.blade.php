          ...
          <div class="row">
            ...
            <div class="col-auto ms-auto d-print-none">
              <div class="btn-list d-flex">
                <a href="{{ getPreviousUrl(route('student.dashboard.students.index')) }}"
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-12 text-center mt-3 mb-5">
                  <span id="photoPreview" class="avatar avatar-custom-size rounded position-relative"
                    ...
                    <div class="form-control-plaintext">
                      ...
                      @if ($student->coreTeam)
                        <img src="{{ asset('img/sosmed/verified.png') }}" alt="" height="20"
                          data-bs-toggle="tooltip" data-bs-placement="top" title="Pengurus Inti">
                      @endif
                    </div>
                  </div>
                </div>
                ...
                @if ($student->coreTeam)
                  <div class="col-12">
                    <div class="mb-3">
                      <label class="form-label">Pragram Kerja ({{ $student->coreTeam->position }})</label>
                      <ul>
                        @foreach ($student->coreTeam->workingPrograms as $program)
                          <li>{{ $program->name }}</li>
                        @endforeach
                        @if ($student->coreTeam->workingPrograms->isEmpty())
                          <span class="text-muted">Belum memiliki program kerja</span>
                        @endif
                      </ul>
                    </div>
                  </div>
