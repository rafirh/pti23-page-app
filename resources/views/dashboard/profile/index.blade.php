                ...
                <div class="row justify-content-center mt-3 ">
                  <div class="col-12 text-center">
                    ...
                    <span id="photoPreview" class="avatar avatar-custom-size rounded position-relative mb-5"
                      style="background-image: url({{ auth()->user()->avatar_url ?? asset('img/default.jpg') }})">
                      <label>
                        <button class="btn btn-icon btn-muted rounded-circle btn-edit-avatar" type="button"
                      ...
                      <input type="file" class="form-control" name="photo" id="photoInput" hidden
                        accept=".jpg,.jpeg,.png">
                    </span>
                  </div>
                    ...
                    <div class="datagrid">
                      <div class="datagrid-item">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                          placeholder="Nama lengkap" name="name" value="{{ old('name') ?? auth()->user()->name }}">
                      </div>
                    </div>
                  </div>
                  <div class="col-12 mb-3">
